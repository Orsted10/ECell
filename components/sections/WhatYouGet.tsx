...
export default function WhatYouGet() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="relative z-10 w-full h-[100vh] overflow-hidden flex flex-col justify-between items-center py-5 px-4 sm:px-8"
      >
        ...
        {/* TOP VIEWPORT HEADER — Section Title + Glowing HUD Bar (100% Zero Overlap) */}
        <div className="relative z-30 w-full max-w-6xl flex flex-col items-center gap-2.5 text-center pt-2">
          {/* Header Eyebrow Pill */}
          ...
          {/* TOP HUD TAB NAVIGATION — Zero Overlap & Zero Edge Cutoff */}
          <div className="w-full max-w-5xl mt-1.5 px-2">
            <div className="flex items-center justify-center p-2.5 sm:p-3 rounded-2xl bg-black/85 border border-white/20 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.95)]">
              <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto no-scrollbar py-1 px-3 w-full justify-between">
                {OFFERINGS.map((pillar, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 sm:gap-2.5 px-3.5 sm:px-4 py-2 rounded-xl font-mono text-xs sm:text-sm font-black transition-all duration-300 whitespace-nowrap ${
                        isActive
                    ...
                    >
                      ...
                      />
                      <span className="font-mono font-black text-xs sm:text-sm tracking-wider" style={{ color: isActive ? "#FFFFFF" : "#CBD5E1" }}>
                        {pillar.pillarNo}
                      </span>
